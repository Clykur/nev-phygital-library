  ...
  "whitespace-nowrap inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 hover-elevate",
  {
    ...
    compoundVariants: [
      ...
      { variant: "solid", status: "info", className: "bg-info text-info-foreground" },
      {
        variant: "solid",
        status: "neutral",
        className: "bg-background border border-border text-foreground-muted",
      },
      ...
      },
      {
        variant: "soft",
        status: "error",
        className: "bg-error-surface text-error-foreground border-error-border",
      },
      {
        variant: "soft",
        status: "warning",
      ...
      },
      {
        variant: "soft",
        status: "info",
        className: "bg-info-surface text-info-foreground border-info-border",
      },
      {
        variant: "soft",
        status: "neutral",
        className: "bg-background text-foreground-muted border-border",
      },
      ...
      // Outline variants
      {
        variant: "outline",
        status: "success",
        className: "text-success-foreground border-success bg-transparent",
      },
      {
        variant: "outline",
        status: "error",
        className: "text-error-foreground border-error bg-transparent",
      },
      {
        variant: "outline",
        status: "warning",
        className: "text-warning-foreground border-warning bg-transparent",
      },
      {
        variant: "outline",
        status: "info",
        className: "text-info-foreground border-info bg-transparent",
      },
      {
        variant: "outline",
        status: "neutral",
        className: "text-foreground-muted border-border bg-transparent",
      },
    ],
    defaultVariants: {
      variant: "default",

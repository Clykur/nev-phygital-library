  ...
  return (
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-500">
      ...
      <section className="text-center max-w-4xl mx-auto space-y-4">
        <div className="inline-flex items-center space-x-2 px-3 py-1 bg-primary/10 border border-blue-900/60 rounded-full text-[10px] font-mono font-medium text-blue-400 uppercase tracking-widest">
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
          <div className="bg-muted/50/30 border border-border/60 p-4 rounded-xl flex flex-col justify-between">
            ...
            <span className="text-[9px] font-mono text-emerald-400 mt-2">● Checked in now</span>
          </div>
          ...
          <div className="bg-muted/50/30 border border-border/60 p-4 rounded-xl flex flex-col justify-between">
            ...
            <span className="text-2xl font-bold text-blue-400 mt-1 tracking-tight">{stats.activeBorrows}</span>
            <span className="text-[9px] font-mono text-blue-500 mt-2">NFC Wallet Managed</span>
          </div>
          ...
          <div className="bg-muted/50/30 border border-border/60 p-4 rounded-xl flex flex-col justify-between col-span-1">
            ...
            <span className="text-[9px] font-mono text-emerald-500 mt-2">✓ Preservation Optimal</span>
          </div>
          ...
          <div className="flex flex-col space-y-2 md:col-span-1 border-r-0 md:border-r border-border/60 md:pr-4">
            {specifications.map((spec, index) => {
              ...
              return (
                ...
                >
                  <SpecIcon className={`w-4 h-4 ${isSelected ? 'text-blue-500' : 'text-muted-foreground/60'}`} />
          ...
          <div className="md:col-span-3 min-h-[220px] flex flex-col justify-between">
            <div className={`p-6 rounded-2xl bg-gradient-to-br ${specifications[selectedSpec].color} border border-border/60/40 relative overflow-hidden flex flex-col justify-between h-full`}>
              <div className="space-y-4">
                <div>
                  <span className="text-[9px] font-mono uppercase font-bold text-blue-400 tracking-wider">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-muted/50/10 border border-border/60 p-6 rounded-2xl space-y-2">
          <div className="w-8 h-8 rounded-full bg-blue-950 flex items-center justify-center text-xs font-mono font-bold text-blue-400 border border-blue-800/60">01</div>
        ...
        <div className="bg-muted/50/10 border border-border/60 p-6 rounded-2xl space-y-2">
          <div className="w-8 h-8 rounded-full bg-indigo-950 flex items-center justify-center text-xs font-mono font-bold text-primary border border-indigo-800/60">02</div>

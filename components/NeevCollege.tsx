...
import { LibraryZone, PhygitalBook } from '../services/neevData';
...
export const NeevCollege: React.FC<any> = ({
  ...
  const handleAddSyllabusBook = (e: React.FormEvent) => {
    ...
    const campusBook: PhygitalBook = {
      ...
      shelfLocation: {
        aisle: targetShelf.charAt(0).toUpperCase() as any || 'B',
    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-[20px] duration-500">
      ...
      <section className="bg-muted/50/40 border border-zinc-805/80 rounded-2xl p-6 md:p-8 relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative z-10">
          <div className="space-y-2 max-w-2xl">
            <div className="inline-flex items-center space-x-1.5 px-3 py-1 bg-primary/10 border border-blue-900/60 rounded-full text-[10px] font-mono font-medium text-blue-400 uppercase tracking-widest">
      ...
      <section className="bg-muted/50/10 border border-zinc-805/80 rounded-2xl p-6 space-y-4 animate-in fade-in duration-300">
        <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-3 border-b border-border pb-3">
          ...
          <span className="text-[9px] font-mono px-2 py-0.5 bg-emerald-950 text-emerald-400 rounded border border-emerald-900/40 font-bold uppercase tracking-wider">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="p-4 bg-background/40 border border-border rounded-xl space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-[9px] font-mono bg-blue-950 text-blue-400 px-2 py-0.5 rounded border border-blue-900/40 font-bold">LEDGER A</span>
              <span className="text-[9px] text-emerald-400 font-mono font-bold uppercase tracking-widest animate-pulse">● Operating proceed active</span>
            </div>
            <div>
            ...
            <div className="pt-2 border-t border-border flex justify-between font-mono text-[9px]">
              ...
              <span className="text-blue-400 font-bold uppercase">100% Capitalized Spend</span>
            </div>
          </div>
          ...
          <div className="p-4 bg-background/40 border border-border rounded-xl space-y-3 relative overflow-hidden">
            <div className="flex justify-between items-center">
              <span className="text-[9px] font-mono bg-amber-950 text-amber-500 px-2 py-0.5 rounded border border-amber-900/40 font-bold">LEDGER B</span>
            ...
            <div className="pt-2 border-t border-border flex justify-between font-mono text-[9px]">
              ...
              <span className="text-amber-500 font-bold uppercase tracking-wider">ZERO EXPLOIT BURN ALLOWED</span>
            </div>
          </div>
        </div>
      </section>
              ...
              return (
                <div
                  ...
                  className={`p-3.5 rounded-xl border text-left cursor-pointer transition-all ${
                    isActive
                      ? 'bg-blue-950/20 border-blue-800 shadow-md shadow-blue-900/5'
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    ...
                    {isActive && (
                      <span className="text-[9px] font-mono uppercase px-1.5 py-0.5 bg-blue-900/40 text-blue-400 border border-blue-800 rounded shrink-0">
                        ACTIVE CAMPUS
                      </span>
                    )}
                  </div>
        ...
        <div className="lg:col-span-2 bg-muted/50/20 border border-border/60 rounded-2xl p-5 md:p-6">
          <form onSubmit={handleCollegeOnboard} className="space-y-4">
            ...
            <button
              ...
              className="w-full py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 disabled:from-zinc-800 hover:from-blue-500 hover:to-indigo-505 disabled:text-muted-foreground/50 border border-blue-500/10 rounded-xl font-bold text-xs text-foreground tracking-wider flex items-center justify-center space-x-2 transition"
            >
              {onboardSuccess ? (
                <>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1 bg-background/40 p-2.5 rounded-xl border border-border">
                <div className="flex justify-between text-[10px] font-mono text-muted-foreground/50">
                  ...
                  <span className="text-blue-400 font-bold">{customShelfX}%</span>
                </div>
                <input
                  type="range"
                  min="10"
        ...
        <div className="bg-muted/50/30 border border-border/60 rounded-2xl p-5 space-y-4">
          ...
          <form onSubmit={handleAddSyllabusBook} className="space-y-3.5 text-xs">
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center text-[10px] font-mono text-muted-foreground/60">
                ...
                <button
                  ...
                  className="text-blue-400 hover:text-foreground transition"
                >
            ...
            <button
              ...
              className="w-full py-2 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-505 hover:to-teal-505 border border-emerald-500/10 rounded-xl font-bold text-xs text-foreground flex items-center justify-center space-x-1 px-4 transition"
            >
              {bookRegistered ? (
                <>
